...
class MainWindow:
    def __init__(self, master):
        ...
        self.lstMakes.pack(side=LEFT, fill=Y)
        ...
        self.treeCars.column("CarID", width=100)
        self.treeCars.column("Make", width=175)
        self.treeCars.column("Model", width=175)
        self.treeCars.column("Doors", width=100)
        #tree.heading("#0", text='ID', anchor='w')
        #tree.column("#0", anchor="w")
        self.treeCars.heading("CarID", text="CarID")
        self.treeCars.heading("Make", text="Make")
        self.treeCars.heading("Model", text="Model")
        self.treeCars.heading("Doors", text="Doors")
        data = TVClassExample()
        self.treeCars.pack(data)
